...
async def intermidiate_research_prompt(research: dict, research_data: List) -> ResearchAnalysisOutput:
...
- ALREADY FORMATED DATA - ALREADY FORMATED DATA. New data will be used to fullfill the remaning 
